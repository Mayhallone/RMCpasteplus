...
1. Start the utility and click ok.
...
5. A progress bar will be visible and indicate the paste function progress.
...
I prefer Ubuntu 20.04 inside Windows 10 (WSL) and this is currently the only fully supported setup.
